...
- **`routers/`** — Route handlers organized by domain:
  ...
  - `trade.go` — `/api/trade/trade-records` — trade records with date range filtering (default 90 days), includes summary stats (profit_count, loss_count, avg_performance)
